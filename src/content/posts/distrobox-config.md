...
lang: en
description: "A comprehensive guide to configuring Distrobox containers with custom homes, Docker access, and Oh My Zsh installations."
---
...
**Path:** 
```bash 
  /home/<your_user>/distrobox/development/.zshrc
```
